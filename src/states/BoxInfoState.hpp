...
/* 
 * File:   BoxInfoState.hpp
 * Author: Redbuzard
 *
 * Created on 18 janvier 2020, 20:20
 */

#ifndef BOXINFOSTATE_HPP
#define BOXINFOSTATE_HPP

#include "State.hpp"
#include "../ui/states/UIPokemonInfo.hpp"

class BoxInfoState : public State{
public:
//=================// Constructor //==================//
    
    BoxInfoState(StateStack* stack, Character* character);
...
//=================// Graphical Attributes //==================//
    ...
    // The UI for the Box Info State
    UIPokemonInfo m_ui;
};

#endif /* BOXINFOSTATE_HPP */
